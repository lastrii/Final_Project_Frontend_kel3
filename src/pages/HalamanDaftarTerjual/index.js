...
import ilus from '../../assets/images/illustrasiSeller.svg';
								...
								<div className="kontenCardMenuPenjual">
									...
									<p>
										<a href="/halamandaftarterjual" className="icon2" style={{ margin: 7, padding: 7 }}>
											<AttachMoneyIcon style={{ color: '#7126b5' }} /> <span style={{ color: '#7126b5' }}>Terjual</span> <ChevronRightIcon style={{ color: '#7126b5' }} />{' '}
										</a>
									</p>
								</div>
							</Card>
